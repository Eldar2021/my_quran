...
MqHatimParticipantsDetailModel _$MqHatimParticipantsDetailModelFromJson(
...
Map<String, dynamic> _$MqHatimParticipantsDetailModelToJson(
  MqHatimParticipantsDetailModel instance,
) => <String, dynamic>{
  'id': instance.id,
