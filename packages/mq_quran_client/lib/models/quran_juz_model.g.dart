...
part of 'quran_juz_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

QuranJuzModel _$QuranJuzModelFromJson(Map<String, dynamic> json) => QuranJuzModel(
...
Map<String, dynamic> _$QuranJuzModelToJson(QuranJuzModel instance) => <String, dynamic>{
  'id': instance.id,
