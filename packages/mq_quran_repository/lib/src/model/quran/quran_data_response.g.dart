...
QuranDataMetaResponse _$QuranDataMetaResponseFromJson(Map<String, dynamic> json) => QuranDataMetaResponse(
      filters: QuranDataFilterResponse.fromJson(json['filters'] as Map<String, dynamic>),
    );
