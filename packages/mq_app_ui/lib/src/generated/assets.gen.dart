...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/user_female.svg
  SvgGenImage get userFemale => const SvgGenImage('assets/icons/user_female.svg');
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/background_blue_dark.png
  AssetGenImage get backgroundBlueDark => const AssetGenImage('assets/images/background_blue_dark.png');

  /// File path: assets/images/background_orange.png
  AssetGenImage get backgroundOrange => const AssetGenImage('assets/images/background_orange.png');
