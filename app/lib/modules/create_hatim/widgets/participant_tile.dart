  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
      ...
      leading: CircleAvatar(
        ...
        child: Assets.icons.userMale.svg(colorFilter: ColorFilter.mode(colorScheme.onSurface, BlendMode.srcIn)),
      ),
      title: Text(
        '${user.firstName} ${user.lastName}',
        overflow: TextOverflow.ellipsis,
        style: prTextTheme.titleMedium?.copyWith(fontWeight: FontWeight.w400),
      ),
      subtitle: Text(
        '${user.userName}',
        overflow: TextOverflow.ellipsis,
